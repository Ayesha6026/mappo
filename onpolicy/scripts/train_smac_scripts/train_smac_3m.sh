...
# python ../train/train_smac.py --env_name StarCraft2 --algorithm_name rmappo --experiment_name checkreplay --map_name 3m --seed 1 --n_training_threads 1 --n_rollout_threads 1 --num_mini_batch 1 --episode_length 400 --num_env_steps 1000 --ppo_epoch 15 --use_value_active_masks --use_eval --eval_episodes 32