...
class StarCraft2Env(MultiAgentEnv):
    ...
    def step(self, actions_agents, actions_enemy):
        ...
        agent_tuple = [(self._controllers[self.agent_index], action) for action in sc_agent_actions]
        enemy_tuple = [(self._controllers[self.enemy_index], action) for action in sc_actions_enemy]
        action_tuples = agent_tuple + enemy_tuple
        ...
        try:
            ...
            req = ((c.actions, sc_pb.RequestAction(actions=a)) for c, a in action_tuples)
